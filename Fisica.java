...
public class Fisica{
    public static void main(String[] args) { // iniciando main
        ...
        double segundos, alturaInicial, aceleracao; // variáveis de input
        double alturaFinal, velocidadeFinal, deslocamentoVertical; // variáveis de cálculo
        boolean certo = false; // variável de confirmação
        ...
        // variáveis de diagramação

        String resultado = "=== RESULTADO ===";
        int largura = 160;
        int espacos = (largura - resultado.length()) / 2;
        ...
        do{
            ...
            try {
                ...
                // Resultados
                System.out.println("\n" + BRANCO_BACKGROUND + PRETO + linha + RESET);
                System.out.println(BRANCO_BACKGROUND + PRETO + " ".repeat(espacos) + resultado + " ".repeat(largura - resultado.length() - espacos) + RESET);
                System.out.println(BRANCO_BACKGROUND + PRETO + linha + RESET);
